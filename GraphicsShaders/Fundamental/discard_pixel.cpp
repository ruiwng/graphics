...
int main() {
	...
	// ====================================
	// vertex shader
	Shader discardShader("discard_pixel.vert", "discard_pixel.frag");
	...
	while (!glfwWindowShouldClose(window)) {
		...
		discardShader.setUniform("view", view);
		discardShader.setUniform("projection", projection);
		discardShader.setUniform("frequency", 20.0f);
		discardShader.setUniform("density", 0.2f);
		pSphere->draw();
