...
int main() {
	...
	// ====================================
	// vertex shader
	Shader sphereShader("rippled_surface.vert", "rippled_surface.frag");

	// uncomment this call to dray in wireframe polygons
	//glPolygonMode(GL_FRONT_AND_BACK, GL_LINE);
	Quad* pQuad = new Quad(1000, 1000);
	...
	while (!glfwWindowShouldClose(window)) {
		...
		glm::mat4 view = glm::lookAt(glm::vec3(0.0f, 6.0f, 6.0f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 0.0f, -1.0f));
