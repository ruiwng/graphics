...
// Defines serveral possible options for camera movement. Used as abstraction to stay away from window-system specific input methods
...
public:
	...
	//Returns the view matrix calculated using Eulers Angles and the LookAt Matrix
